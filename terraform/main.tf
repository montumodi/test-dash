...
resource "aws_security_group" "VPN-SG" {
  description = "This security group was generated by AWS Marketplace and is based on recommended settings for OpenVPN Access Server version 2.8.5 provided by OpenVPN Inc."
  egress = [
    {
      cidr_blocks = [
        "0.0.0.0/0",
  ...
  name   = "OpenVPN Access Server-2.8.5-AutogenByAWSMP--2"
  vpc_id = module.my_vpc_module.vpc_id
}
...
resource "aws_instance" "vpn" {
  ...
  subnet_id                   = module.my_vpc_module.public_subnet_a_id
  tags = {
    "Name" = "vpn"
  }
  tags_all = {
